...
sequence_calibration_toward_atrium.py
Description:
    This scripts contains the command sequence and controller to calibrate the camera
    toward the atrium (facing the arm from the right side)
"""
...
def calibration_toward_atrium(initial_move, roll, pitch, yaw, width, depth, height):
    """ Command Sequence """
