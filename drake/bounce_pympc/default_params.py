...
x_max = np.array(   [l,     8*d-2.*r, 1.2*np.pi,  l,      5*d-2.*r, 500.,     500.,     10.,    50.,     50.])    # state upper bounds
x_min = - x_max                                                                                         # state lower bounds
xn_max = np.array(  [0.1,   1.5,    1.2*np.pi,  0.1,    0.8,    0.1,    5.0,    0.1,    0.1,    5.0])   # terminal state upper bounds
xn_min = np.array(  [-0.1,  1.0,   -1.2*np.pi, -0.1,   -0.8,   -0.1,   -5.0,   -0.1,   -0.1,   -5.0])   # terminal state lower bounds
