...
Description:
    ...
    - Commands Twists instead of poses
"""
...
class Command():
    ...
    Description:
        ...
        - Duration.
    """
    def __init__(self, target_twist=np.zeros((6,)), gripper_value=0.0, duration=2.5, name=None):
        """
        Description:
        ...
        self.ee_target_twist = target_twist
    ...
    def __str__(self):
        string = "%s: \n" % self.name
        string += "    end effector target twist : %s\n" % self.ee_target_twist
...
class CommandSequence():
    """
    Description:
        This object contains a sequence of Command objects.
    ...
    def __init__(self,command_list):
        """
        Description:
            Constructor of cCommandSequence
        """
    ...
    def ee_target_twist(self,t):
        return self.current_command(t).ee_target_twist
